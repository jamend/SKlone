/****** Object:  Stored Procedure dbo.CancelPeace    Script Date: 5/1/2004 6:12:37 PM ******/
CREATE PROCEDURE dbo.CancelPeace
	(
		@kdID int,
...
AS
		...
		SET @Result = 'You have canceled peace status with the <b>' + @AllianceName + '</b> alliance. '
		END
