        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    Else
                        Dim SqlCommand1 As New SqlClient.SqlCommand("dbo.CreateKingdomB", Session.Item("sqlConnection"))
                        ...
                        Else
                            ...
                            SqlCommand1.Parameters.Add("@Galaxy", SqlDbType.Int)
                            SqlCommand1.Parameters(9).Value = Filter(txtGalaxy.Text)
                            SqlCommand1.Parameters.Add("@Sector", SqlDbType.Int)
                            SqlCommand1.Parameters(10).Value = Filter(txtSector.Text)
                            SqlCommand1.Parameters.Add("@GroupPassword", SqlDbType.NVarChar, 15)
                            SqlCommand1.Parameters(11).Value = Filter(txtGroupPassword.Text)
                            ...
                            Select Case SqlCommand1.Parameters("@Result").Value
                                ...
                                Case 6
                                    lblError.Text = "Sector <b>" + txtGalaxy.Text + "</b> : <b>" + txtSector.Text + "</b> is at it max of 20 members choose another sector."
                                Case 7
                                    lblError.Text = "This is the wrong password for sector <b>" + txtGalaxy.Text + "</b> : <b>" + txtSector.Text + "</b>."
                                Case 8
                                    lblError.Text = "Sector <b>" + txtGalaxy.Text + "</b> : <b>" + txtSector.Text + "</b> has had the 4 max group sign ups, select a different sector."
                            End Select
                        End If
                        Session.Item("sqlConnection").Close()
                    End If
