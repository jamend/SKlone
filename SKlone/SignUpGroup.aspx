<%@ Page Language="vb" AutoEventWireup="false" Inherits="SKlone.SignUpGroup" CodeBehind="SignUpGroup.aspx.vb" %>
...
<input type="hidden" name="business" value="cephas_is@hotmail.com">
<input type="hidden" name="item_name" value="SKlone">
			...
			<TR vAlign="top" height="*">
				<TD>
					<TABLE height="100%" cellSpacing="0" cellPadding="0" width="100%">
																		...
																		<TABLE style="FONT-SIZE: xx-small; COLOR: white; FONT-FAMILY: verdana" cellSpacing="0"
																			...
																			<TBODY>
																				...
																				<TR>
																					...
																					<TD><ASP:TEXTBOX id="txtAccount" runat="server" maxlength="16" width="160px"></ASP:TEXTBOX></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 108px; HEIGHT: 24px">Password:
																					</TD>
																					<TD style="HEIGHT: 24px"><ASP:TEXTBOX id="txtPassword" runat="server" maxlength="16" width="160px" textmode="Password"></ASP:TEXTBOX></TD>
																				</TR>
																				<TR>
																					...
																					<TD>
																						<P><ASP:TEXTBOX id="txtConfirm" runat="server" maxlength="16" width="160px" textmode="Password"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																				...
																				<TR>
																					...
																					<TD>
																						<P><ASP:TEXTBOX id="txtEmail" runat="server" maxlength="255" width="160px"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																				...
																				<TR>
																					...
																					<TD>
																						<P><ASP:TEXTBOX id="txtKingdomName" runat="server" maxlength="24" width="160px"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																					...
																					<TD>
																						<P><ASP:TEXTBOX id="txtRuler" runat="server" maxlength="24" width="160px"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																				...
																				<TR>
																					...
																					<TD>
																						<P><SELECT id="cboRaceType" style="WIDTH: 160px" name="cboRaceType" runat="server">
																							...
																							<asp:hyperlink id="racehelp" NavigateUrl="Help.aspx" runat="server">Race and Planet Help</asp:hyperlink><BR>
																						</P>
																					</TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 108px; HEIGHT: 37px"><FONT color="#efefaf" size="2"><B>Select Sector:</B>
																						</FONT>
																					</TD>
																					<TD style="HEIGHT: 37px"></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 108px">Galaxy:</TD>
																					<TD>
																						<P><ASP:TEXTBOX id="txtGalaxy" runat="server" maxlength="2" width="29px"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 108px">Sector:</TD>
																					<TD>
																						<P><ASP:TEXTBOX id="txtSector" runat="server" maxlength="2" width="29px"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 108px">Password:</TD>
																					<TD>
																						<P><ASP:TEXTBOX id="txtGroupPassword" runat="server" maxlength="15" width="93px" TextMode="Password"></ASP:TEXTBOX></P>
																					</TD>
																				</TR>
																				<TR>
																					<TD align="center" colSpan="2"><FONT face="verdana" color="#ffffff" size="1"></FONT></TD>
																				</TR>
																				<TR>
																					<TD align="center" colSpan="2"><FONT face="verdana" color="#ffffff" size="1"><br>
						...
						<TR>
							<TD background="images/sklonebar2.gif" colspan="6" height="26"><FONT face="verdana" color="#fffff0" style="FONT-SIZE: 8pt; FILTER: blur(strength=2); WIDTH: 336px; HEIGHT: 17px"><B>&nbsp;&nbsp;© 2002-2004 Jonathan Amend, Richard Allen Paul</B> </FONT>
							</TD>
						</TR>
					</TABLE>
				</TD>
