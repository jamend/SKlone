...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GalaxyNetworth.aspx.vb" Inherits="SKlone.GalaxyNetworth" %>
		...
		<FONT face="verdana" size="1">
			...
			<P align="center"><ASP:LABEL id="lblRulerName" runat="server"></ASP:LABEL>, this 
				table represents the high scores for the top <B>Galaxy
					<ASP:LABEL id="lblGalaxy" runat="server"></ASP:LABEL>&nbsp;Networth</B>
			</P>
