...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Sent.aspx.vb" Inherits="SKlone.Sent" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		<FORM runat="server">
			...
			<FONT face="verdana" size="1"><FONT face="verdana" size="1">
				...
				<P align="center"><ASP:TABLE id="tblMessages" runat="server" gridlines="Both" width="95%" font-names="Verdana" font-size="XX-Small" borderwidth="1px"></ASP:TABLE><ASP:LABEL id="lblNoMessages" runat="server" font-size="X-Small" visible="False">No Messages</ASP:LABEL></P>
				<P align="center"><BR>
					<BR>
