...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StrongestSectors.aspx.vb" Inherits="SKlone.StrongestSectors" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		...
		<FONT face="verdana" size="1">
			...
			<P align="center">
				...
				the high scores for the top <B>Sectors in the Universe</B>&nbsp;
			</P>
			<P align="center">
