...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim SqlCommand1 As New SqlClient.SqlCommand("SELECT TOP 100 dbo.FullKingdomNameC(kdID), Kills, MissilesLaunched FROM Scores WHERE (Kills + MissilesLaunched) > 0 ORDER BY (Kills + MissilesLaunched) DESC", Session.Item("sqlConnection"))
