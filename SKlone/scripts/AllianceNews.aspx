<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AllianceNews.aspx.vb" Inherits="SKlone.scripts.AllianceNews" validateRequest="false" %>
		...
		<FONT face="verdana" size="1">
			<FORM id="Form1" method="post" runat="server">
				...
				<P align="center"><ASP:LABEL id="lblRulerName" runat="server"></ASP:LABEL>, welcome 
					to the alliance news. View current or past wars that have taken place 
					concerning your alliance.</P>
				<P align="center"><ASP:DATAGRID id="DataGrid1" runat="server" font-names="Verdana" bordercolor="Black" backcolor="#222222" autogeneratecolumns="False" cellspacing="-1" font-size="XX-Small" borderwidth="1px" width="80%">
					...
					</ASP:DATAGRID><ASP:LABEL id="lblNoAlliance" runat="server" visible="False">Your sector is not currently in an alliance.</ASP:LABEL></P>
				<P align="center">&nbsp;</P>
