...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim SqlCommand1 As New SqlClient.SqlCommand("SELECT TOP 100 dbo.FullKingdomNameC(Kingdoms.kdID), dbo.KingdomLand(Kingdoms.kdID) AS Land FROM Kingdoms, Sectors WHERE Sectors.Galaxy = " & Session.Item("Galaxy") & " AND Kingdoms.SectorID = Sectors.SectorID ORDER BY Land DESC", Session.Item("sqlConnection"))
