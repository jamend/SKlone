Partial Class StrongestSectors
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim SqlCommand1 As New SqlClient.SqlCommand("SELECT TOP 100 dbo.FullSectorName(SectorID), dbo.SectorNetworth(SectorID) AS Networth FROM Sectors WHERE dbo.SectorNetworth(SectorID) > 0 ORDER BY Networth DESC", Session.Item("sqlConnection"))
