Partial Class UniverseNetworth
...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents lblGalaxy As System.Web.UI.WebControls.Label
    Protected WithEvents gf As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim SqlCommand1 As New SqlClient.SqlCommand("SELECT TOP 100 dbo.FullKingdomNameC(kdID), Networth FROM Kingdoms ORDER BY Networth DESC", Session.Item("sqlConnection"))
