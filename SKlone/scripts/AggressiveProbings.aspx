...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AggressiveProbings.aspx.vb" Inherits="SKlone.scripts.AggressiveProbings" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		...
		<FONT face="verdana" size="1">
			...
			<P align="center">
				...
				the high scores for the top <B>Universe&nbsp;Land</B>
			</P>
			<P align="center">
				<ASP:TABLE id="tblScores" runat="server" borderstyle="Solid" borderwidth="1px" bordercolor="Black"
					...
					<asp:TableRow HorizontalAlign="Center" BackColor="#424242">
						...
						<asp:TableCell Text="Population Stolen"></asp:TableCell>
						<asp:TableCell Text="Money Stolen"></asp:TableCell>
						<asp:TableCell Text="Homes Burned"></asp:TableCell>
						<asp:TableCell Text="Power Plants Burned"></asp:TableCell>
					</asp:TableRow>
				</ASP:TABLE></P>
			<P align="center">&nbsp;</P>
		</FONT>
