...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MostKills.aspx.vb" Inherits="SKlone.MostKills" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		...
		<FONT face="verdana" size="1">
			...
			<P align="center">
				...
				the high scores for the top&nbsp;<STRONG>Amount of Kills and Missiles Launched in 
					the Universe.</STRONG>&nbsp;
			</P>
			<P align="center">
				<ASP:TABLE id="tblScores" runat="server" borderstyle="Solid" borderwidth="1px" bordercolor="Black"
					...
					<asp:TableRow HorizontalAlign="Center" BackColor="#424242">
						...
						<asp:TableCell Text="Kills"></asp:TableCell>
						<asp:TableCell Text="Missiles Launched"></asp:TableCell>
					</asp:TableRow>
				</ASP:TABLE></P>
			<P align="center">&nbsp;</P>
		</FONT>
