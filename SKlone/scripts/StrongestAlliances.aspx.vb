Partial Class StrongestAlliances
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim SqlCommand1 As New SqlClient.SqlCommand("SELECT TOP 100 dbo.AllianceLink(AllianceID), Networth, AverageNetworth FROM Alliances WHERE Networth != 0 ORDER BY Networth DESC", Session.Item("sqlConnection"))
        ...
        While SqlData1.Read()
            ...
            tblScores.Rows(x).Cells(3).Text = SqlData1.GetInt64(2).ToString(NumberFormatString)
