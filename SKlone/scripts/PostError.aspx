...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PostError.aspx.vb" Inherits="SKlone.PostError" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		...
		<FONT face="verdana" size="1">
			<FORM id="Form1" runat="server">
				<P align="center">&nbsp;</P>
				<P align="center">You have left some of the required fields blank. Please hit BACK 
