...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StrongestAlliances.aspx.vb" Inherits="SKlone.StrongestAlliances" %>
	...
	<BODY text="#ffffff" vlink="#447cff" alink="#4e9f5f" link="#447cff" bgcolor="#000000">
		...
		<FONT face="verdana" size="1">
			...
			<P align="center"><ASP:LABEL id="lblRulerName" runat="server"></ASP:LABEL>, this 
				table represents the high scores for the top <B>Alliances in the Universe</B>
			</P>
			<P align="center"><ASP:TABLE id="tblScores" runat="server" gridlines="Both" horizontalalign="Center" width="80%"
					font-size="XX-Small" font-names="Verdana" backcolor="#222222" bordercolor="Black" borderwidth="1px" borderstyle="Solid">
					<ASP:TABLEROW horizontalalign="Center" backcolor="#424242">
						<ASP:TABLECELL text="&nbsp;"></ASP:TABLECELL>
						<ASP:TABLECELL text="Alliance"></ASP:TABLECELL>
						<ASP:TABLECELL text="Total Networth"></ASP:TABLECELL>
						<ASP:TABLECELL text="Average Networth"></ASP:TABLECELL>
					</ASP:TABLEROW>
				</ASP:TABLE></P>
			<P align="center">&nbsp;</P>
		</FONT>
